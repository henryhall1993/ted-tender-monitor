...
INPUT_CSV = "results/uk_medical_devices.csv"
OUTPUT_CSV = "results/uk_medical_devices_parsed.csv"
...
Below is a public tender notice from the United Kingdom.
...
def main():
    if not os.path.exists(INPUT_CSV):
        print(f"Input file {INPUT_CSV} not found — skipping UK parsing.")
        return
    ...
    print(f"Found {len(rows)} UK tenders. Processing all...\n")
    ...
    print(f"\nDone — {len(results)} UK tenders parsed and saved to {OUTPUT_CSV}")
